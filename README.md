...
| Комбинация | Действие |
|:---|:---|
| `Alt` + `↑` `↓` `←` `→` | Перемещение по матрице рабочих столов |
| `Alt` + `1-9` | Перемещение на конкретный рабочий стол |
| `Ctrl` + `Alt` + `↑` `↓` `←` `→` | Перемещение активного окна по матрице рабочих столов |
| `Ctrl` + `Alt` + `1-9` | Перемещение активного окна на конкретный рабочий стол |
...
> *Присоединяйтесь к нашему Telegram-каналу, чтобы следить за обновлениями и обсуждать развитие оболочки.*
