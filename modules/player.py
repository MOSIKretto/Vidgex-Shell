...
class PlayerSmall(CenterBox):
    def __init__(self):
        ...
        self._display_options = ["title", "artist"]  # Убрали "cavalcade"
        self._display_index = 0
        self._current_display = "title"  # По умолчанию показываем заголовок
        ...
        # Удалили создание cavalcade и cavalcade_box
        ...
        self.center_stack = Stack(
            ...
            v_expand=False,
            children=[
                self.mpris_label,  # Теперь только метка
            ]
        )
