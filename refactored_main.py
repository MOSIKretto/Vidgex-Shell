"""Refactored main module following DRY principles."""
...
from refactored_notch import Notch
from refactored_bar import Bar
from widgets.corners import Corners
from refactored_dock import Dock

# Import cleanup functions for metrics and other services
from refactored_metrics import MetricsProvider
...
class ShellManager:
    ...
    def cleanup(self) -> None:
        ...
        # Unlink components from each other
        ...
        # Clean up metrics provider
        try:
            metrics_provider = MetricsProvider()
            metrics_provider.destroy()
        except Exception:
            pass
    ...
    def create_components(self, monitor_id: int, multi_monitor: bool, app_widgets: List[Any], monitor_manager: Optional[Any]) -> Dict[str, Any]:
        ...
        if monitor_id == 0:
            ...
            # Create notification popup with widgets reference
